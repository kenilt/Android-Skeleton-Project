...
/**
 * Created by thangnguyen on 2019-07-17.
 */
class NetworkBoundResourceTest {
    ...
    fun whenSuccess_returnSuccessData() {
        val box = String()
        val result = object: NetworkBoundResource<String>(executor) {
            override fun getCall(): Call<String> {
                return Calls.response(Response.success(box))
            }
        }.asLiveData()
