...
public class PullRefreshLayout extends ViewGroup {
    ...
    protected static final int DRAG_MAX_DISTANCE = 64;
    ...
    protected int mSpinnerFinalOffset;
    protected int mTotalDragDistance;
    protected RefreshDrawable mRefreshDrawable;
    ...
    protected int mInitialOffsetTop;
    protected boolean mDispatchTargetTouchDown;
    protected float mDragPercent;
...
//        mRefreshView.measure(MeasureSpec.makeMeasureSpec(mRefreshViewWidth, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(mRefreshViewHeight, MeasureSpec.EXACTLY));
    ...
    protected void animateOffsetToCorrectPosition() {
        mFrom = mCurrentOffsetTop;
    ...
    protected final Animation mAnimateToStartPosition = new Animation() {
        @Override
    ...
    protected final Animation mAnimateToCorrectPosition = new Animation() {
        @Override
        public void applyTransformation(float interpolatedTime, Transformation t) {
    ...
    protected Animation.AnimationListener mToStartListener = new Animation.AnimationListener() {
        @Override
        public void onAnimationStart(Animation animation) {
            mRefreshDrawable.stop();
        }
...
//            mRefreshDrawable.stop();
    ...
    protected void setTargetOffsetTop(int offset, boolean requiresUpdate) {
